...
import { getCompanyData, registerBankDetails, registerCompany, registerCompanyContact, registerCompanyOperations, registerCompanyOverview, registerReferences } from "../controllers/company.controller.js";
const router = Router();
