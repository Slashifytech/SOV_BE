...
import { registerBankDetails, registerCompany, registerCompanyContact, registerCompanyOperations, registerCompanyOverview } from "../controllers/company.controller.js";
const router = Router();
